...
<?php
session_start();
if(isset($_SESSION['user_name'] ) && $_SESSION['type']== 'Teaching' ){
?>
...
<body>
  <section id="container" class="">
     <header class="header dark-bg">
      <a href="#" class="logo">Teaching <span class="lite">Staff</span></a>
      <p><?php
        include "tea.php";
      ?></p>
     </header>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        <ul class="sidebar-menu">
          <li><a class="" href="slot_av.php">
                          <i class="icon_table"></i>
                          <span>Slot Availability</span></a></li>

         <!--   <li><a class="" href="adjust.php">
                          <i class="icon_table"></i>
                          <span>Duty Adjustment</span></a></li> -->               
