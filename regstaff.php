...
<?php include('regb.php') ?>
  ...
  <title>Registration</title>
    ...
    <script type="text/javascript">
            ...
            function Select(){
              ...
              var u = "Student";
               var v=document.getElementById("rollno");
                var w=document.getElementById("rock");
          ...
          var v= "Non-Teaching";
           ...
           var q=document.getElementById("pst1");
                var o=document.getElementById("pst");
            if(x==w||x==v){
 ...
 <body>
  <form action="regstaff.php" method="POST">

         
         <h1>Staffs Registration</h1> 
 ...
 <br>
          ...
          <br></br>
           ...
           <label for="name" id="rock" style="display: none;">Roll No<span class="req"></label>
          <input type="text" id="rollno"  style="display: none;" name="roll" >
